    ...
    <footer style={{ backgroundColor: "#050505" }} className="pt-20 pb-8">
      <div className="container">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 text-center sm:text-left">
          {/* Brand */}
          <div>
            <a href="/" className="flex items-center gap-1.5 mb-4 justify-center sm:justify-start hover:opacity-80 transition-opacity">
            ...
            <div className="flex items-center gap-4 justify-center sm:justify-start">
              ...
              <a
                href="https://instagram.com/zafirinvest"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
